        ...
        <div className="min-h-screen bg-gray-100 flex">
            ...
            <aside className="w-64 bg-slate-900 text-white flex-shrink-0 shadow-xl">
                ...
                <nav className="mt-4">
                    ...
                    <Link href={route('admin.categories.index')} className={`block py-3 px-6 hover:bg-slate-700 ${route().current('admin.categories.*') ? 'bg-slate-700 border-l-4 border-indigo-500' : ''}`}>
                        カテゴリ管理
                    </Link>
                </nav>
            </aside>
